...
class HSNCode(models.Model):
    ...
    gst_rate = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
...
class Product(models.Model):
    ...
    unit_of_measure = models.DecimalField(null=True, blank=True, decimal_places=2, max_digits=100)
    # class Meta:
    #     constraints = [
...
class ProductDescription(models.Model):
    ...
    unit = models.DecimalField(null=True, blank=True, max_digits=100, decimal_places=2)
    rate = models.DecimalField(null=True, blank=True, max_digits=100, decimal_places=2)
    ...
    igst = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
...
class SalesInvoice(models.Model):
    ...
    taxable_amount = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    totalall_gst = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    total_invoice_value = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds_tcs_rate = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True, default=0.00)
    # tds_tcs_section = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True, default=0.00)
    tcs = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    amount_receivable = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    def __str__(self):
...
class PurchaseInvoice(models.Model):
    ...
    total_invoice_value = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds_tcs_rate = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True, default=0.00)
    # tds_tcs_section = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tcs = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    amount_receivable = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
...
class DebitNote(models.Model):
    ...
    totalall_gst = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    total_invoice_value = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds_tcs_rate = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds_tcs_section = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tcs = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    tds = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    amount_receivable = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
...
class PF(models.Model):
    ...
    gross_ctc = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    basic_pay = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    hra = models.DecimalField(max_digits=100, decimal_places=2, null=True, blank=True)
    statutory_bonus =models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    special_allowance = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    pf = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    gratuity = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    total_gross_salary = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=False)
    number_of_days_in_month = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    present_days = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    lwp = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    leave_adjustment = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    gender = models.CharField(choices=gender, max_length=100, null=True, blank=True)
    basic_pay_monthly = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    hra_monthly = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    statutory_bonus_monthly = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    special_allowance_monthly = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    total_gross_salary_monthly = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    provident_fund = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    professional_tax = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    advance = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    esic_employee = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    tds = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    total_deduction = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    net_pay = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    advance_esic_employer_cont =models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
...
class TDSPayment(models.Model):
    ...
    cgst = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    sgst = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    igst = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    total_amt = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    tds_rate = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    tds_section = models.CharField(max_length=100 ,null=True, blank=True)
    tds_amount = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    net_amount = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)

# TDS Return
class TDSReturn(models.Model):
    client = models.ForeignKey(Client, on_delete=models.CASCADE, null=True, blank= True)
    challan_date = models.DateField(null=True, blank=True)
    challan_no = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    challan_type = models.CharField(max_length=100 ,null=True, blank=True)
    tds_section = models.CharField(max_length=100 ,null=True, blank=True)
    amount = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
    last_filed_return_ack_no = models.DecimalField(decimal_places=2, max_digits=100, null=True, blank=True)
