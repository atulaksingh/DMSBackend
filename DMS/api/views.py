...
def detail_client(request, pk, section=None):
    ...
    section_map = {
        ...
        'taxaudit': lambda: TaxAuditSerializer(TaxAudit.objects.filter(client=client), many=True).data,
        ...
        'tdspayment': lambda: TDSPaymentSerializer(TDSPayment.objects.filter(client=client), many=True).data,
        'tdsreturn': lambda: TDSReturnSerializer(TDSReturn.objects.filter(client=client), many=True).data,
        'tdssection': lambda: TDSSectionSerializer(TDSSection.objects.all(), many=True).data,
