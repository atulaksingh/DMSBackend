...
def fill_income_forms(driver):
    ...
    df = pd.read_excel(r"income100.xlsx")  
    # df = df.iloc[100:] 
            ...
            try:
                ...
                try:
                    cancel_btn = WebDriverWait(driver, 3).until(
                        EC.element_to_be_clickable((By.NAME, "income_cancel"))
                    )
                    cancel_btn.click()
                    time.sleep(1)
                except TimeoutException:
